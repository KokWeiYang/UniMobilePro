...
class _EditProfilesState extends State<EditProfiles> {
  ...
  void updateProfile() {
    ...
    String _add1 = _proadd1Controller.text.toString();
    ...
    if (_fname.isEmpty || _lname.isEmpty) {
      Fluttertoast.showToast(
          ...
          fontSize: 16.0);
      return;
    } else if (_add1.isEmpty || _add2.isEmpty) {
      Fluttertoast.showToast(
          ...
          return AlertDialog(
            ...
            actions: [
              TextButton(
                ...
                onPressed: () {
                  Navigator.of(context).pop();
                  _updateprofile(_fname, _lname, _add1, _add2, _post, _city,
                      _state, _phone);
                },
              ),
              TextButton(
  ...
  void _updateprofile(String _fname, String _lname, String _add1, String _add2,
      String _post, String _city, String _state, String _phone) {
